...
contract ArkanaTest is Test {
    ...
    function test_EntryThenWithdraw_Integration() public {
        ...
        // Prepare publicInputs for withdraw (17 elements: 8 inputs + 9 outputs)
        // NOTE: amount is now private, so it's not in publicInputs
        // NOTE: Timelock parameters have been removed
        bytes32[] memory withdrawPublicInputs = new bytes32[](17);
        ...
        withdrawPublicInputs[7] = bytes32(uint256(0x00)); // is_tl_swap (0 = false, 1 = true) - 0 for normal withdraw

        // Public outputs (9 elements)
        ...
        withdrawPublicInputs[11] = bytes32(uint256(0x05855fd7cf8d5fe5d1f51463dc91c18fc82e00ddc4fc42d853fb4311d03c50a1)); // encrypted_state_details[0] (encryptedBalance)
        withdrawPublicInputs[12] = bytes32(uint256(0x271deab6946acc6af9027774c2a962872f718cd8e490c9f25436c9c591c5cd8b)); // encrypted_state_details[1] (encryptedNullifier)
        ...
        withdrawPublicInputs[15] = bytes32(uint256(0x00)); // tl_hashchain (0 for normal withdraw)
        withdrawPublicInputs[16] = bytes32(uint256(0x07a120)); // final_amount (actual withdrawal amount, 0 if TL swap) = 500,000
