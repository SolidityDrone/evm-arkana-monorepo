...
contract ArkanaTest is Test {
    ...
    function test_EntryThenWithdraw_Integration() public {
        ...
        bytes32[] memory withdrawPublicInputs = new bytes32[](25);

        // Public inputs (17 elements)
        ...
        // The Noir test used a different token_address, so the root will be different
        withdrawPublicInputs[4] = bytes32(rootAfterEntry); // expected_root (use root from entry step)
        ...
        withdrawPublicInputs[9] = bytes32(uint256(0x25d3f92d5d6b7b15cd6360cd746b5001e3ffd7bb0c6d3949158a0214a8d8b268)); // H_x (G1 point) - hash_to_curve(round)
        withdrawPublicInputs[10] = bytes32(uint256(0xb11034b64b10d4cdff425fba3d857e96cd23738789e68df5d64ccca881c8b05)); // H_y (G1 point)
        withdrawPublicInputs[11] = bytes32(uint256(0x783acf9cadf136444573178ba540c058d95b61a13534e7a502519e2b61f4a82)); // V_x (G1 point) - r * H
        withdrawPublicInputs[12] = bytes32(uint256(0xe33c8f04f0bd7d88455203080b3fc81164f11d9afecf1da64e2a422d0fcb8e3)); // V_y (G1 point)
        withdrawPublicInputs[13] = bytes32(uint256(0x923e1d4de1ad26d2258943a10f8cee94fc5516be3074fd75b494ae72e8bbb39)); // C1_x0 (G2 point) - r * G2_gen (real) - AUTO-GENERATED
        withdrawPublicInputs[14] = bytes32(uint256(0x2fa991f9d9654a6fe03a19c891e3f8298e59e7d579907c23766e8c071a99607d)); // C1_x1 (G2 point) - r * G2_gen (imag) - AUTO-GENERATED
        withdrawPublicInputs[15] = bytes32(uint256(0x1f86545bd5d6b6cd70010f39e89725793cfb578a9aa37d88c64a039b40e4f1a)); // C1_y0 (G2 point) - r * G2_gen (real) - AUTO-GENERATED
        withdrawPublicInputs[16] = bytes32(uint256(0x5ddbacaa77db26735b8554c800cbf0f159a85a2e5ec71dffbaffbffaf4574f7)); // C1_y1 (G2 point) - r * G2_gen (imag) - AUTO-GENERATED
