...
void Edwards2Montgomery_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Edwards2Montgomery_10_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Multiplexor2_13_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Multiplexor2_13_run(uint ctx_index,Circom_CalcWit* ctx);
void BitElementMulAny_14_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BitElementMulAny_14_run(uint ctx_index,Circom_CalcWit* ctx);
void Montgomery2Edwards_15_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Montgomery2Edwards_15_run(uint ctx_index,Circom_CalcWit* ctx);
...
void SegmentMulAny_17_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void SegmentMulAny_17_run(uint ctx_index,Circom_CalcWit* ctx);
void EscalarMulAny_18_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void EscalarMulAny_18_run(uint ctx_index,Circom_CalcWit* ctx);
...
void PedersenCommitment5_24_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void PedersenCommitment5_24_run(uint ctx_index,Circom_CalcWit* ctx);
void PedersenCommitment2FixedM1_25_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void PedersenCommitment2FixedM1_25_run(uint ctx_index,Circom_CalcWit* ctx);
void Entry_26_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Entry_26_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[27] = { 
...
Num2Bits_8_run,
IsZero_9_run,
Edwards2Montgomery_10_run,
MontgomeryDouble_11_run,
MontgomeryAdd_12_run,
Multiplexor2_13_run,
BitElementMulAny_14_run,
Montgomery2Edwards_15_run,
BabyAdd_16_run,
SegmentMulAny_17_run,
EscalarMulAny_18_run,
SegmentMulAny_19_run,
SegmentMulAny_20_run,
EscalarMulAny_21_run,
SegmentMulAny_22_run,
EscalarMulAny_23_run,
PedersenCommitment5_24_run,
PedersenCommitment2FixedM1_25_run,
Entry_26_run };
Circom_TemplateFunction _functionTableParallel[27] = { 
NULL,
NULL,
NULL,
NULL,
...
uint get_total_signal_no() {return 36963;}

uint get_number_of_components() {return 4538;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 6796;}

uint get_size_of_constants() {return 187;}
...
Fr_mul(&expaux[4],&circuitConstants[165],&signalValues[mySignalStart + 2]); // line circom 137
...
Fr_mul(&expaux[5],&circuitConstants[165],&signalValues[mySignalStart + 2]); // line circom 138
...
Fr_sub(&expaux[1],&expaux[2],&circuitConstants[164]); // line circom 140
...
Fr_sub(&expaux[2],&expaux[3],&circuitConstants[164]); // line circom 105
...
Multiplexor2_13_create(mySignalStart+22,2+ctx_index+1,ctx,new_cmp_name,myId);
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Multiplexor2_13_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
PFrElement aux_dest = &signalValues[mySignalStart + 8];
// load src
Fr_mul(&expaux[2],&circuitConstants[166],&signalValues[mySignalStart + 2]); // line circom 42
...
Fr_mul(&expaux[4],&circuitConstants[163],&signalValues[mySignalStart + 9]); // line circom 45
...
{
Fr_mul(&expaux[4],&circuitConstants[163],&signalValues[mySignalStart + 9]); // line circom 46
...
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_mul(&expaux[3],&circuitConstants[162],&signalValues[mySignalStart + 6]); // line circom 48
...
Fr_mul(&expaux[4],&circuitConstants[163],&signalValues[mySignalStart + 9]); // line circom 48
...
{
Fr_mul(&expaux[4],&circuitConstants[163],&signalValues[mySignalStart + 9]); // line circom 49
...
Fr_mul(&expaux[4],&circuitConstants[162],&signalValues[mySignalStart + 6]); // line circom 49
...
BitElementMulAny_14_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 29 ;
aux_cmp_num += 4;
}
...
Edwards2Montgomery_10_create(mySignalStart+3817,508+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[127] = 508+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_15_create(mySignalStart+3838,511+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[128] = 511+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_16_create(mySignalStart+3821,509+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[129] = 509+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_13_create(mySignalStart+3831,510+ctx_index+1,ctx,new_cmp_name,myId);
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Edwards2Montgomery_10_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
BitElementMulAny_14_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[167]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Montgomery2Edwards_15_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
SegmentMulAny_17_create(mySignalStart+132,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "zeropoint";
IsZero_9_create(mySignalStart+3974,513+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[160]); // line circom 156
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
SegmentMulAny_17_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
Fr_sub(&expaux[2],&circuitConstants[169],&signalValues[mySignalStart + 130]); // line circom 162
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
...
// load src
Fr_sub(&expaux[2],&circuitConstants[170],&signalValues[mySignalStart + 131]); // line circom 163
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_10_create(mySignalStart+4417,588+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[147] = 588+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_15_create(mySignalStart+4438,591+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[148] = 591+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_16_create(mySignalStart+4421,589+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[149] = 589+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_13_create(mySignalStart+4431,590+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[172]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_10_create(mySignalStart+3157,420+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[105] = 420+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_15_create(mySignalStart+3178,423+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[106] = 423+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_16_create(mySignalStart+3161,421+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[107] = 421+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_13_create(mySignalStart+3171,422+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[175]); // line circom 92
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[1])) + 0);
{
...
SegmentMulAny_19_create(mySignalStart+278,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
SegmentMulAny_20_create(mySignalStart+4720,596+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 596+ctx_index+1;
}
{
std::string new_cmp_name = "doublers";
MontgomeryDouble_11_create(mySignalStart+268,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_15_create(mySignalStart+274,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "adders";
BabyAdd_16_create(mySignalStart+258,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "zeropoint";
IsZero_9_create(mySignalStart+7902,1021+ctx_index+1,ctx,new_cmp_name,myId);
...
// load src
Fr_mul(&expaux[1],&lvar[3],&circuitConstants[171]); // line circom 157
...
// load src
Fr_sub(&expaux[2],&circuitConstants[169],&signalValues[mySignalStart + 256]); // line circom 162
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[3].offset+map_accesses_aux[0]];
// load src
Fr_sub(&expaux[2],&circuitConstants[170],&signalValues[mySignalStart + 257]); // line circom 163
cmp_index_ref_load = 5;
cmp_index_ref_load = 5;
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_10_create(mySignalStart+697,92+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[23] = 92+ctx_index+1;
}
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_15_create(mySignalStart+718,95+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[24] = 95+ctx_index+1;
}
{
std::string new_cmp_name = "eadder";
BabyAdd_16_create(mySignalStart+701,93+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[25] = 93+ctx_index+1;
}
{
std::string new_cmp_name = "lastSel";
Multiplexor2_13_create(mySignalStart+711,94+ctx_index+1,ctx,new_cmp_name,myId);
...
{
std::string new_cmp_name = "segments";
SegmentMulAny_22_create(mySignalStart+28,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "zeropoint";
IsZero_9_create(mySignalStart+750,97+ctx_index+1,ctx,new_cmp_name,myId);
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
SegmentMulAny_22_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
Fr_sub(&expaux[2],&circuitConstants[169],&signalValues[mySignalStart + 26]); // line circom 162
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
Fr_mul(&expaux[1],&expaux[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 162
...
// load src
Fr_sub(&expaux[2],&circuitConstants[170],&signalValues[mySignalStart + 27]); // line circom 163
cmp_index_ref_load = 1;
cmp_index_ref_load = 1;
Fr_mul(&expaux[1],&expaux[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 163
...
ctx->componentMemory[coffset].templateName = "PedersenCommitment5";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 5;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
Num2Bits_6_create(mySignalStart+4024,519+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 519+ctx_index+1;
}
{
std::string new_cmp_name = "m2_bits";
Num2Bits_6_create(mySignalStart+8130,1035+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1035+ctx_index+1;
}
{
std::string new_cmp_name = "m3_bits";
Num2Bits_7_create(mySignalStart+16164,2059+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 2059+ctx_index+1;
}
{
std::string new_cmp_name = "m4_bits";
Num2Bits_8_create(mySignalStart+17172,2159+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 2159+ctx_index+1;
}
{
std::string new_cmp_name = "r_bits";
Num2Bits_7_create(mySignalStart+25102,3183+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 3183+ctx_index+1;
}
{
std::string new_cmp_name = "m1G";
EscalarMulAny_18_create(mySignalStart+47,4+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 4+ctx_index+1;
}
{
std::string new_cmp_name = "m2H";
EscalarMulAny_18_create(mySignalStart+4153,520+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 520+ctx_index+1;
}
{
std::string new_cmp_name = "m3D";
EscalarMulAny_21_create(mySignalStart+8259,1036+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 1036+ctx_index+1;
}
{
std::string new_cmp_name = "m4K";
EscalarMulAny_23_create(mySignalStart+16419,2060+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 2060+ctx_index+1;
}
{
std::string new_cmp_name = "rJ";
EscalarMulAny_21_create(mySignalStart+17197,2160+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 2160+ctx_index+1;
}
{
std::string new_cmp_name = "add1";
BabyAdd_16_create(mySignalStart+7,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "add2";
BabyAdd_16_create(mySignalStart+17,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "add3";
BabyAdd_16_create(mySignalStart+27,2+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 2+ctx_index+1;
}
{
std::string new_cmp_name = "add4";
BabyAdd_16_create(mySignalStart+37,3+ctx_index+1,ctx,new_cmp_name,myId);
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[160]); // line circom 369
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 5;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[10])) + 2)];
// load src
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
// end load src
...
PFrElement aux_dest = &lvar[10];
// load src
Fr_add(&expaux[0],&lvar[10],&circuitConstants[1]); // line circom 369
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[160]); // line circom 369
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
EscalarMulAny_18_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[10];
// load src
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[160]); // line circom 377
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 6;
{
...
cmp_index_ref_load = 1;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + ((1 * Fr_toInt(&lvar[10])) + 0)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
PFrElement aux_dest = &lvar[10];
// load src
Fr_add(&expaux[0],&lvar[10],&circuitConstants[1]); // line circom 377
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[160]); // line circom 377
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[161]); // line circom 385
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 7;
{
...
cmp_index_ref_load = 2;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + ((1 * Fr_toInt(&lvar[10])) + 0)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
PFrElement aux_dest = &lvar[10];
// load src
Fr_add(&expaux[0],&lvar[10],&circuitConstants[1]); // line circom 385
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[161]); // line circom 385
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[63]); // line circom 393
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 8;
{
...
cmp_index_ref_load = 3;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + ((1 * Fr_toInt(&lvar[10])) + 0)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
PFrElement aux_dest = &lvar[10];
// load src
Fr_add(&expaux[0],&lvar[10],&circuitConstants[1]); // line circom 393
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[63]); // line circom 393
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[161]); // line circom 401
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 9;
{
...
cmp_index_ref_load = 4;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + ((1 * Fr_toInt(&lvar[10])) + 0)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
PFrElement aux_dest = &lvar[10];
// load src
Fr_add(&expaux[0],&lvar[10],&circuitConstants[1]); // line circom 401
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[161]); // line circom 401
...
{
std::string new_cmp_name = "r_bits";
Num2Bits_7_create(mySignalStart+7918,1024+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 1024+ctx_index+1;
}
{
std::string new_cmp_name = "rH";
EscalarMulAny_21_create(mySignalStart+13,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "add";
BabyAdd_16_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[161]); // line circom 87
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 1;
{
...
ctx->componentMemory[coffset].templateName = "Entry";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 3;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
Poseidon2Hash3_5_create(mySignalStart+35251,4374+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 4374+ctx_index+1;
}
{
std::string new_cmp_name = "nonce_commitment_hash";
Poseidon2Hash3_5_create(mySignalStart+25367,3185+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 3185+ctx_index+1;
}
{
std::string new_cmp_name = "balance_commit";
PedersenCommitment5_24_create(mySignalStart+10,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "nonce_discovery";
PedersenCommitment2FixedM1_25_create(mySignalStart+27078,3348+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 3348+ctx_index+1;
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 8];
// load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
PedersenCommitment5_24_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
PedersenCommitment2FixedM1_25_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 3];
// load src
...
Entry_26_create(1,0,ctx,"main",0);
Entry_26_run(0,ctx);
}
