...
void UnpackUnlocksAt_38_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void UnpackUnlocksAt_38_run(uint ctx_index,Circom_CalcWit* ctx);
...
void AbsorbWithdraw_42_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void AbsorbWithdraw_42_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_main_input_signal_no() {return 85;}

uint get_total_signal_no() {return 296819;}

uint get_number_of_components() {return 29849;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 50359;}
...
Num2Bits_7_create(mySignalStart+3991,516+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 516+ctx_index+1;
}
{
std::string new_cmp_name = "r_bits";
Num2Bits_8_create(mySignalStart+12025,1540+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1540+ctx_index+1;
}
{
std::string new_cmp_name = "mG";
EscalarMulAny_19_create(mySignalStart+14,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "rH";
EscalarMulAny_22_create(mySignalStart+4120,517+ctx_index+1,ctx,new_cmp_name,myId);
...
Bits2Num_37_create(mySignalStart+28,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "b2n_lock";
Bits2Num_37_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[coffset].templateName = "AbsorbWithdraw";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 85;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[27]{0};
}
...
Poseidon2Hash3_5_create(mySignalStart+292829,29515+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 29515+ctx_index+1;
}
{
std::string new_cmp_name = "view_key_hash";
Poseidon2Hash2_6_create(mySignalStart+295108,29685+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 29685+ctx_index+1;
}
{
std::string new_cmp_name = "previous_nonce_commitment_hash";
Poseidon2Hash3_5_create(mySignalStart+282955,28327+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 28327+ctx_index+1;
}
{
std::string new_cmp_name = "base3_commit";
PedersenCommitmentBase3_25_create(mySignalStart+105,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "previous_m1G";
PedersenCommitmentM1_26_create(mySignalStart+278846,27810+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 27810+ctx_index+1;
}
{
std::string new_cmp_name = "previous_rJ";
PedersenCommitmentR_27_create(mySignalStart+284666,28490+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 28490+ctx_index+1;
}
{
std::string new_cmp_name = "previous_add1";
BabyAdd_17_create(mySignalStart+277116,27645+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 27645+ctx_index+1;
}
{
std::string new_cmp_name = "previous_add2";
BabyAdd_17_create(mySignalStart+277126,27646+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 27646+ctx_index+1;
}
{
std::string new_cmp_name = "previous_leaf_hash";
Poseidon2Hash2_6_create(mySignalStart+277136,27647+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 27647+ctx_index+1;
}
{
std::string new_cmp_name = "leaf_eq";
IsEqual_28_create(mySignalStart+16868,1976+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 1976+ctx_index+1;
}
{
std::string new_cmp_name = "merkle_verify";
LeanIMTVerify_32_create(mySignalStart+16874,1978+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 1978+ctx_index+1;
}
{
std::string new_cmp_name = "note_stack_commit";
PedersenCommitment2_33_create(mySignalStart+150230,15243+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 15243+ctx_index+1;
}
{
std::string new_cmp_name = "note_stack_leaf_hash";
Poseidon2Hash2_6_create(mySignalStart+162516,16787+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 16787+ctx_index+1;
}
{
std::string new_cmp_name = "note_stack_leaf_hash_provided";
Poseidon2Hash2_6_create(mySignalStart+164226,16950+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 16950+ctx_index+1;
}
{
std::string new_cmp_name = "note_stack_leaf_eq";
IsEqual_28_create(mySignalStart+162510,16785+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 16785+ctx_index+1;
}
{
std::string new_cmp_name = "note_stack_merkle_verify";
LeanIMTVerify_32_create(mySignalStart+165936,17113+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 17113+ctx_index+1;
}
{
std::string new_cmp_name = "combined_balance_check";
GreaterThanOrEqualField_36_create(mySignalStart+13174,1643+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[16] = 1643+ctx_index+1;
}
{
std::string new_cmp_name = "unpack";
UnpackUnlocksAt_38_create(mySignalStart+294800,29681+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[17] = 29681+ctx_index+1;
}
{
std::string new_cmp_name = "time_check";
GreaterThanOrEqualField_36_create(mySignalStart+294540,29678+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[18] = 29678+ctx_index+1;
}
{
std::string new_cmp_name = "new_nonce_commitment_hash";
Poseidon2Hash3_5_create(mySignalStart+132183,13029+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[19] = 13029+ctx_index+1;
}
{
std::string new_cmp_name = "new_m1G";
PedersenCommitmentM1_26_create(mySignalStart+128074,12512+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[20] = 12512+ctx_index+1;
}
{
std::string new_cmp_name = "new_rJ";
PedersenCommitmentR_27_create(mySignalStart+133894,13192+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[21] = 13192+ctx_index+1;
}
{
std::string new_cmp_name = "new_add1";
BabyAdd_17_create(mySignalStart+128054,12510+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[22] = 12510+ctx_index+1;
}
{
std::string new_cmp_name = "new_add2";
BabyAdd_17_create(mySignalStart+128064,12511+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[23] = 12511+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt_balance";
PoseidonCTREncrypt_40_create(mySignalStart+13434,1646+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[24] = 1646+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt_nullifier";
PoseidonCTREncrypt_40_create(mySignalStart+15151,1811+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[25] = 1811+ctx_index+1;
}
{
std::string new_cmp_name = "nonce_discovery";
PedersenCommitment2FixedM1_41_create(mySignalStart+142057,14217+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[26] = 14217+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
...
cmp_index_ref_load = 9;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[9]].signalStart + 0],&circuitConstants[1]); // line circom 115
}}
...
cmp_index_ref_load = 14;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + 0],&circuitConstants[1]); // line circom 153
}}
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[79]); // line circom 161
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 15;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 58)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
LeanIMTVerify_32_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &signalValues[mySignalStart + 99];
// load src
Fr_add(&expaux[2],&signalValues[mySignalStart + 17],&signalValues[mySignalStart + 98]); // line circom 172
Fr_sub(&expaux[1],&expaux[2],&signalValues[mySignalStart + 14]); // line circom 172
Fr_sub(&expaux[0],&expaux[1],&signalValues[mySignalStart + 8]); // line circom 172
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 100];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 14],&signalValues[mySignalStart + 8]); // line circom 176
Fr_add(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 176
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 101];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 17],&signalValues[mySignalStart + 98]); // line circom 178
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = 16;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[16]].signalStart + 0],&circuitConstants[1]); // line circom 182
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 102];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 18],&signalValues[mySignalStart + 98]); // line circom 186
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
UnpackUnlocksAt_38_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 103];
// load src
...
cmp_index_ref_load = 18;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[18]].signalStart + 0],&circuitConstants[1]); // line circom 199
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 104];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 16],&circuitConstants[1]); // line circom 203
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
AbsorbWithdraw_42_create(1,0,ctx,"main",0);
AbsorbWithdraw_42_run(0,ctx);
}
