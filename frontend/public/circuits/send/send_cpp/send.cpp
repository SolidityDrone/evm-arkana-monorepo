...
void GreaterThanOrEqualField_35_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void GreaterThanOrEqualField_35_run(uint ctx_index,Circom_CalcWit* ctx);
void PerformDHKeyExchange_36_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void PerformDHKeyExchange_36_run(uint ctx_index,Circom_CalcWit* ctx);
void Poseidon2Hash1_37_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Poseidon2Hash1_37_run(uint ctx_index,Circom_CalcWit* ctx);
...
void PedersenCommitment2_40_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void PedersenCommitment2_40_run(uint ctx_index,Circom_CalcWit* ctx);
...
void Send_42_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Send_42_run(uint ctx_index,Circom_CalcWit* ctx);
...
Num2Bits_33_run,
LessThan_34_run,
GreaterThanOrEqualField_35_run,
PerformDHKeyExchange_36_run,
Poseidon2Hash1_37_run,
PoseidonKeystream_38_run,
PoseidonCTREncrypt_39_run,
PedersenCommitment2_40_run,
...
uint get_total_signal_no() {return 204532;}

uint get_number_of_components() {return 21686;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 36035;}
...
{
std::string new_cmp_name = "n2b";
Num2Bits_33_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
if (!Fr_isTrue(&circuitConstants[1])) std::cout << "Failed assert in template/function " << myTemplateName << " line 90. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
LessThan_34_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[coffset].templateName = "Send";
ctx->componentMemory[coffset].signalStart = soffset;
...
Poseidon2Hash3_5_create(mySignalStart+201104,21357+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 21357+ctx_index+1;
}
{
std::string new_cmp_name = "view_key_hash";
Poseidon2Hash2_6_create(mySignalStart+202821,21522+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 21522+ctx_index+1;
}
{
std::string new_cmp_name = "unlocks_is_one";
IsEqual_8_create(mySignalStart+202815,21520+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 21520+ctx_index+1;
}
{
std::string new_cmp_name = "previous_nonce_commitment_hash";
Poseidon2Hash3_5_create(mySignalStart+189261,20003+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 20003+ctx_index+1;
}
{
std::string new_cmp_name = "base3_commit";
PedersenCommitmentBase3_26_create(mySignalStart+69,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "previous_m1G";
PedersenCommitmentM1_27_create(mySignalStart+185152,19486+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 19486+ctx_index+1;
}
{
std::string new_cmp_name = "previous_rJ";
PedersenCommitmentR_28_create(mySignalStart+190972,20166+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 20166+ctx_index+1;
}
{
std::string new_cmp_name = "previous_add1";
BabyAdd_18_create(mySignalStart+183422,19321+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 19321+ctx_index+1;
}
{
std::string new_cmp_name = "previous_add2";
BabyAdd_18_create(mySignalStart+183432,19322+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 19322+ctx_index+1;
}
{
std::string new_cmp_name = "previous_leaf_hash";
Poseidon2Hash2_6_create(mySignalStart+183442,19323+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 19323+ctx_index+1;
}
{
std::string new_cmp_name = "leaf_eq";
IsEqual_8_create(mySignalStart+36070,4349+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 4349+ctx_index+1;
}
{
std::string new_cmp_name = "merkle_verify";
LeanIMTVerify_32_create(mySignalStart+36076,4351+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 4351+ctx_index+1;
}
{
std::string new_cmp_name = "shares_check";
GreaterThanOrEqualField_35_create(mySignalStart+200844,21354+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 21354+ctx_index+1;
}
{
std::string new_cmp_name = "new_nonce_commitment_hash";
Poseidon2Hash3_5_create(mySignalStart+153095,15565+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 15565+ctx_index+1;
}
{
std::string new_cmp_name = "new_m1G";
PedersenCommitmentM1_27_create(mySignalStart+148986,15048+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[14] = 15048+ctx_index+1;
}
{
std::string new_cmp_name = "new_rJ";
PedersenCommitmentR_28_create(mySignalStart+154806,15728+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[15] = 15728+ctx_index+1;
}
{
std::string new_cmp_name = "new_add1";
BabyAdd_18_create(mySignalStart+147256,14883+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[16] = 14883+ctx_index+1;
}
{
std::string new_cmp_name = "new_add2";
BabyAdd_18_create(mySignalStart+147266,14884+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[17] = 14884+ctx_index+1;
}
{
std::string new_cmp_name = "new_leaf_hash";
Poseidon2Hash2_6_create(mySignalStart+147276,14885+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[18] = 14885+ctx_index+1;
}
{
std::string new_cmp_name = "dh";
PerformDHKeyExchange_36_create(mySignalStart+13138,1643+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[19] = 1643+ctx_index+1;
}
{
std::string new_cmp_name = "shared_key_hash_comp";
Poseidon2Hash1_37_create(mySignalStart+199135,21191+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[20] = 21191+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt_amount_receiver";
PoseidonCTREncrypt_39_create(mySignalStart+30919,3854+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[21] = 3854+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt_balance_sender";
PoseidonCTREncrypt_39_create(mySignalStart+32636,4019+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[22] = 4019+ctx_index+1;
}
{
std::string new_cmp_name = "encrypt_nullifier_sender";
PoseidonCTREncrypt_39_create(mySignalStart+34353,4184+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[23] = 4184+ctx_index+1;
}
{
std::string new_cmp_name = "note_commit";
PedersenCommitment2_40_create(mySignalStart+171142,17779+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[24] = 17779+ctx_index+1;
}
{
std::string new_cmp_name = "nonce_discovery";
PedersenCommitment2FixedM1_41_create(mySignalStart+162969,16753+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[25] = 16753+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
...
cmp_index_ref_load = 2;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[1]); // line circom 65
}}
...
cmp_index_ref_load = 10;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[1]); // line circom 121
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 62];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 18],&signalValues[mySignalStart + 16]); // line circom 139
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 63];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 62],&circuitConstants[1]); // line circom 144
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
GreaterThanOrEqualField_35_run(mySubcomponents[cmp_index_ref],ctx);
}
{
cmp_index_ref_load = 12;
cmp_index_ref_load = 12;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[12]].signalStart + 0],&circuitConstants[1]); // line circom 148
}}
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 148. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 64];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 20],&signalValues[mySignalStart + 62]); // line circom 154
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 65];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 19],&circuitConstants[1]); // line circom 158
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &signalValues[mySignalStart + 66];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 17],&signalValues[mySignalStart + 65]); // line circom 197
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
PerformDHKeyExchange_36_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 5];
// load src
...
cmp_index_ref_load = 19;
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[19]].signalStart + 2]);
}
{
uint cmp_index_ref = 20;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Poseidon2Hash1_37_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 68];
// load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
PedersenCommitment2_40_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 9];
// load src
