            ...
            <div className="max-w-2xl mx-auto relative z-10 w-full">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="font-mono text-base md:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
                        Initialize your first position in the Arkana network.
                        This ritual creates your initial commitment in the void.
                    </p>
                </div>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div>
                                                        <label className="block text-xs sm:text-sm font-sans font-bold text-foreground uppercase tracking-wider mb-1 sm:mb-2">
                                                            INITIALIZE AMOUNT {tokenDecimals !== null ? `(${tokenDecimals} decimals)` : ''}
                                                        </label>
                                                    ...
                                                    <SpellButton
                                                        onClick={proof ? handleInitCommit : proveArkanaEntry}
                                                        disabled={Boolean(
                                                            proof
                                                                ? isPending || isConfirming || isSubmitting || !proof || !publicInputs.length || needsApproval
                                                                : isProving || isInitializing || !tokenAddress || !amount
                                                        )}
                                                        variant="primary"
                                                        className="w-full text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                                    >
