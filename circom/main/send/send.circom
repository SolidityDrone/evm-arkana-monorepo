...
// ARKANA-SEND CIRCUIT
// Matches circuits/main/send/src/main.nr
...
template Send() {
    ...
    signal input previous_unlocks_at;  // Must be 0 (send disabled for locked funds)
    ...
    encrypt_balance_sender.plaintext <== new_shares;
    ...
    encrypt_nullifier_sender.plaintext <== nullifier;
...
component main { public [ token_address, chain_id, expected_root, receiver_public_key, relayer_fee_amount ] } = Send();
